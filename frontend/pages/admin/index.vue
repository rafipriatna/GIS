          ...
          <table class="min-w-max w-full table-auto">
            ...
            <tbody class="text-gray-600 text-sm font-light">
              <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left">-6.1792429, 106.6527784</td>
                <td class="py-3 px-6 text-center">Ciputat</td>
                <td class="py-3 px-6 text-center">Jl. Berug Kuvukiland No 7</td>
